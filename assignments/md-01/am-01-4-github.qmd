...
3. Find the repository [git-configuration-USERNAME]{.highlight-yellow} that ends with your GitHub username, and open it.

4. Click on the green "Code" button.

5. Copy the HTTPS URL to your clipboard.

6. Open the fairdatapub-washcentre workspace on posit.cloud: <https://posit.cloud/spaces/588816/content/all?sort=name_asc>
...
1. In Posit Cloud, if not already open, open the `git-configuration-USERNAME` project that ends with your GitHub username.
...
7. Enter your GitHub username and [GitHub Personal Access Token (PAT)]{.highlight-yellow .a} in the "Username" and "Password" fields

::: callout-important
## Do not use your GitHub password

You need to enter the GitHub Personal Access Token (PAT) you created in a previous assignment to push your changes back to GitHub.
:::
...
2. Navigate to the GitHub organisation for the course: <https://github.com/fairdatapub-washcentre>
